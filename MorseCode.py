print("What would you like tanslated into morse code?")
message1 = input("Special characters you can use are ,:'!? ")

morse_codedict = {
    "A" or "a" : "._", "B" or "b" : "_...", "C" or "c" : "_._.", "D" or "d" : "_..", "E" or "e" : ".", "F" or "f" : ".._.", "G" or "g" : "__.",
